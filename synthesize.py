...
class MyArgs:
    def __init__(self, restore_step, mode, source=None, text=None, speaker_id=0, preprocess_config=None,
                 model_config=None, train_config=None, pitch_control=1.0, energy_control=1.0, duration_control=1.0):
